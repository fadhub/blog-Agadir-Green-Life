...
<body class="bg-gray-50">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
            ...
            <p class="mt-2 text-sm text-gray-600">Remplissez le formulaire ci-dessous pour créer un nouvel article.</p>
        </div>

        <!-- Formulaire -->
        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
            <form action="{{ route('admin.articles.store') }}" method="POST" class="space-y-6 p-6">
                @csrf
                ...
                <div>
                    ...
                    <div class="bg-white border border-gray-200 rounded-xl overflow-hidden">
                        <div id="hs-editor-tiptap">
                            ...
                            <div class="h-96 overflow-auto p-4" data-hs-editor-field="">{{ old('content') }}</div>
                        </div>
                    </div>
